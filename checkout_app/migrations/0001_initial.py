    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town_or_city', models.CharField(max_length=24)),
                ...
                ('user_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='profiles_app.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='OrderLineItem',
